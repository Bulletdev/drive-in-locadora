...
const cars = [
  {
    ...
    category: "Sedan",
    year: 2024,
    image: "/cars/toyota-corolla/toyota-corolla-1.jpg",
    pricePerDay: 180,
  ...
  },
  {
    ...
    category: "SUV",
    year: 2024,
    image: "/cars/honda-hrv/honda-hrv-1.jpg",
    pricePerDay: 250,
    transmission: "Automático",
    passengers: 5,
    fuel: "Flex",
  ...
  },
  {
    ...
    category: "Hatchback",
    year: 2024,
    image: "/cars/chevrolet-onix/chevrolet-onix-1.jpg",
    pricePerDay: 120,
    transmission: "Manual",
    passengers: 5,
    fuel: "Flex",
  ...
  },
  {
    ...
    category: "SUV",
    year: 2024,
    image: "/cars/volkswagen-tcross/volkswagen-tcross-1.jpg",
    pricePerDay: 280,
    transmission: "Automático",
    passengers: 5,
    fuel: "Flex",
  ...
  },
  {
    ...
    category: "Hatchback",
    year: 2023,
    image: "/cars/hyundai-hb20/hyundai-hb20-1.jpg",
    pricePerDay: 130,
    transmission: "Manual",
    passengers: 5,
    fuel: "Flex",
  ...
  },
  {
    ...
    category: "SUV",
    year: 2024,
    image: "/cars/jeep-compass/jeep-compass-1.jpg",
    pricePerDay: 320,
    transmission: "Automático",
    passengers: 5,
    fuel: "Flex",
  ...
  },
  {
    ...
    category: "Hatchback",
    year: 2023,
    image: "/cars/fiat-argo/fiat-argo-1.jpg",
    pricePerDay: 110,
    transmission: "Manual",
    passengers: 5,
    fuel: "Flex",
  ...
  },
  {
    ...
    category: "SUV",
    year: 2024,
    image: "/cars/nissan-kicks/nissan-kicks-1.jpg",
    pricePerDay: 260,
    transmission: "Automático",
    passengers: 5,
    fuel: "Flex",
