...
const cars = [
  ...
  },
  {
    ...
    category: "Hatchback",
    year: 2024,
    image: "/chevrolet-onix-hatchback.png",
    pricePerDay: 120,
    transmission: "Manual",
    passengers: 5,
    fuel: "Flex",
  ...
  },
  {
    ...
    category: "Hatchback",
    year: 2023,
    image: "/hyundai-hb20-hatchback.png",
    pricePerDay: 130,
    transmission: "Manual",
    passengers: 5,
    fuel: "Flex",
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <p className="text-muted-foreground">
          <span className="font-semibold text-foreground">{cars.length}</span> veículos encontrados
        </p>
      </div>
